...
export type RP01_RP02_for_CK01 = {
  RodzajPrzedz1: 'RP01' | 'RP02';
  CenaPorMin1: number;
  CenaPorMax1: number;
};

export type RP03_for_CK01 = {
  RodzajPrzedz13: 'RP03';
  CenaPorMin3: number;
  CenaPorMax3: number;
  OpisPrzedz: string;
...
export type RP04_for_CK01 = {
  RodzajPrzedz2: 'RP04';
  WysCenPor1: number;
};

export type CK02<RP extends RodzajPrzedzialu = RodzajPrzedzialu> = {
  SposobUjCeny2: 'CK02';
  ProcentMin: number;
  ProcentMax: number;
...
export type RP01_RP02_for_CK02 = {
  RodzajPrzedz3: 'RP01' | 'RP02';
  CenaPorMin2: number;
  CenaPorMax2: number;
};

export type RP03_for_CK02 = {
  RodzajPrzedz14: 'RP03';
  CenaPorMin4: number;
  CenaPorMax4: number;
  OpisPrzedz: string;
...
export type KP01_for_MW02_MW03_MW05 = {
  KorektyPorWyn2: 'KP01';
};
...
export type PR02_for_KategoriaA_MW02_MW03_MW05 = {
  RodzPor2: 'PR02';
  PodmiotBadany: PodmiotBadany;
  KrytGeograf: KryteriumGeograficzne;
};

export type RP01_RP02_for_MW02_MW03_MW05 = {
  RodzajPrzedz5: 'RP01' | 'RP02';
  WynikAP1: number;
  WynikAP2: number;
};

export type RP03_for_MW02_MW03_MW05 = {
  RodzajPrzedz15: 'RP03';
  WynikAP3: number;
  WynikAP4: number;
  OpisPrzedz: string;
...
export type RP04_for_MW02_MW03_MW05 = {
  RodzajPrzedz6: 'RP04';
  WynikAP: number;
};

export type MW06<TW extends TechWyceny = TechWyceny> = {
  Metoda06: 'MW06';
...
export type TW01_TW02_for_MW06<TB extends OkresPrognozy = OkresPrognozy> = {
...
export type TW07_for_MW06 = {
  TechWyceny2: 'TW07';
  ZrodloDanychZgodn: ZrodloDanychZgodnosci;
};

export type TW03_to_TW06_for_MW06 = {
