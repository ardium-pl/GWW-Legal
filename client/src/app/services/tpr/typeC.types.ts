...
> = {
  ...
  (MW extends 'MW00' ? MW00 : MW extends 'MW01' | 'MW02' | 'MW03' | 'MW04' | 'MW05' | 'MW06' ? MW01toMW06 : {});
...
> = {
  ...
  (OP extends 'OP01' ? OP01 : OP extends 'OP02' ? OP02 : OP extends 'OP03' ? OP03 : OP extends 'OP04' | 'OP05' ? OP04_OP05 : {}) &
  (RP extends 'RP01' ? RP01 : RP extends 'RP02' ? RP02 : RP extends 'RP03' ? RP03 : {}) ;
...
> = {
  ...
  (SB extends 'SB01' | 'SB02' | 'SB03' | 'SB04' | 'SB05' | 'SB06' | 'SB07' | 'SB08' ? SB01toSB08 : SB extends 'SB09' ? SB09 : {}) &
  (TB extends 'TB01' | 'TB02' | 'TB03' | 'TB04' | 'TB05' | 'TB06' ? TB01toTB06 : TB extends 'TB07' ? TB07 : {});
