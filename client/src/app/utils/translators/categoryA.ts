// import { KC01, KC02, ZW01, ZW02, MW00, MW01, MW04, MW06, MW02_MW03_MW05, Korekta, CK01, CK02, RP01_RP02_for_CK01, RP03_for_CK01, RP04_for_CK01, RP01_RP02_for_CK02, RP03_for_CK02, RP04_for_CK02, RP01_RP02_for_MW02_MW03_MW05, RP03_for_MW02_MW03_MW05, RP04_for_MW02_MW03_MW05, KP01, KP02, TW01_TW02_for_MW06, TW03_to_TW06_for_MW06, TW07_for_MW06 } from 'app/services/tpr/typeA.types';
// import { AllTransactionTables } from 'app/services/tpr/tpr-input.types';

// export function mapKorektaCenTransferowychA(transaction: AllTransactionTables): Partial<KC01 | KC02> {
...
// export function mapZwolnienieArt11nA(transaction: AllTransactionTables): Partial<ZW01 | ZW02> {
...
//                             },
//                         },
//                         transaction.WartoscTransakcjiZwolnienia,
//                     ],
//                 },
//             };
//         case 'ZW02':
...
// function mapZW02A(transaction: AllTransactionTables): Partial<ZW02> {
...
//                         },
//                     },
//                     transaction.WartośćTransakcjiKraju,
//                 ],
//             },
//         });
...
//         Object.assign(zw2, {
//             RodzajTrans2: 'TK02',
//             Kraj: transaction.KodWalutyKrajuTransakcji,
//         });
//     }
...
// export function mapMetodyBadaniaA(transaction: AllTransactionTables): Partial<MW00 | MW01 | MW04 | MW06 | MW02_MW03_MW05<Korekta>> {
...
//                 Metoda01: 'MW01',
//                 Weryfikacja: transaction.SposobWeryfikacjiEynkowegoPoziomuCeny,
//             };
...
//                 Object.assign(mw01, { KorektyPorWyn5: 'KP02', KorektyPorWynProg: transaction.KorektaPorownywalnosciProg });
//             }
...
//             } else if(transaction.KorektaMetodyBadania === 'KP02') {
//                 Object.assign(mw02_03_05, { KorektyPorWyn6: 'KP02', KorektyPorWynProg: transaction.KorektaPorownywalnosciProg });
//             }
...
// function mapSposobUjeciaCeny(transaction: AllTransactionTables): Partial<CK01 | CK02> {
//     switch (transaction.SposobUjeciaCeny) {
//         case 'CK01':
//             const ck01: Partial<CK01> = {
//                 SposobUjCeny1: 'CK01',
//                 Waluta1: transaction.Waluta1,
//                 CenaMin: transaction.CenaMin,
//                 CenaMax: transaction.CenaMax,
...
//                 SposobUjCeny2: 'CK02',
//                 ProcentMin: transaction.ProcentMin,
//                 ProcentMax: transaction.ProcentMax,
...
// function mapRodzajPrzedzialuCK01(transaction: AllTransactionTables): Partial<RP01_RP02_for_CK01 | RP03_for_CK01 | RP04_for_CK01> {
...
//             return {
//                 RodzajPrzedz2: 'RP04',
//                 WysCenPor1: transaction.WysokoscCenyPorownywalnej1,
//             };
//         default:
//             return {};
//     }
...
// function mapRodzajPrzedzialuCK02(transaction: AllTransactionTables): Partial<RP01_RP02_for_CK02 | RP03_for_CK02 | RP04_for_CK02> {
//     switch (transaction.RodzajPrzedzialu) {
//         case 'RP01':
//         case 'RP02':
//             return {
...
//             return {
//                 RodzajPrzedz4: 'RP04',
//                 WysCenPor2: transaction.WysokoscCenyPorownywalnej2,
//             };
//         default:
//             return {};
//     }
...
// function mapRodzajPorownania(transaction: AllTransactionTables): Partial<PR01_PR03_for_MW02_MW03_MW05 | PR02_for_KategoriaA_MW02_MW03_MW05> {
...
// function mapRodzajPrzedzialuMW02_MW03_MW05(transaction: AllTransactionTables): Partial<RP01_RP02_for_MW02_MW03_MW05 | RP03_for_MW02_MW03_MW05 | RP04_for_MW02_MW03_MW05> {
//     switch (transaction.RodzajPrzedzialu) {
//         case 'RP01':
//         case 'RP02':
//             return {
...
// function mapMW04(transaction: AllTransactionTables): Partial<MW04> {
...
// function mapMW06(transaction: AllTransactionTables): Partial<MW06> {
//     const mw06: Partial<MW06> = {
//         Metoda06: 'MW06',
//         SupportVarTechnikaWyceny: transaction.TechWyceny,
//     };
...
//             SupporterVarOkresPrognozy: transaction.OkresPrognozy,
//         });
