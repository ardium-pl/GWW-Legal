...
export function mapKorektaCenTransferowych(transaction: AllTransactionTables): Partial<KC01 | KC02> {
...
export function mapZwolnienieArt11n(transaction: AllTransactionTables): Partial<ZW01 | ZW02> {
...
export function mapZW02(transaction: AllTransactionTables): Partial<ZW02> {
...
export function mapMetodyBadania(transaction: AllTransactionTables): Partial<MW00 | MW01toMW06<Korekta>> {
...
export function mapRodzajOprocentowania(transaction: any): Partial<OP01 | OP02 | OP03 | OP04_OP05> {
...
export function mapRodzajPrzedzialu(transaction: any): Partial<RP01 | RP02 | RP03> {
